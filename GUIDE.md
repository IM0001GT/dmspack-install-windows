...
2. Python 3 → install → tick **Add to PATH**.  
...
- USB: copy the whole `dmlpack-windows` folder next to `evejs-1.0.dmlpack` and `TurtleV2.dmlpack`, or  
- Git:

```powershell
git clone https://github.com/IM0001GT/evejs-dmlpack-windows.git
