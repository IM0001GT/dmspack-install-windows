# dmspack-install-windows

Windows installer for Dad’s MMO Lab **`.dmlpack`** archives (Steam Deck / Linux equivalent: `install-dmlpack-portable.sh`).
...
2. Right-click `Install-DmsPack.portable.ps1` → **Run with PowerShell**  
...
```text
https://github.com/IM0001GT/dmspack-install-windows
```
...
```text
Install-DmsPack.portable.ps1   menu installer
